...
function Steps() {
  return (
    <div className="py-20 mx-4 lg:mx-44 xl:py-40">
      <h1 className="mt-4 text-2xl font-semibold text-center text-transparent md:text-3xl lg:text-4xl bg-gradient-to-r from-gray-900 to-gray-500 bg-clip-text">
      ...
      <div className="flex flex-wrap items-start justify-center gap-6 mt-16 xl:mt-24 ">
        <div className="flex items-start gap-4 pb-10 transition-all duration-500 bg-white border rounded drop-shadow-md p-7 hover:scale-105">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500">dummy text</p>
          </div>
        </div>
        <div className="flex items-start gap-4 pb-10 transition-all duration-500 bg-white border rounded drop-shadow-md p-7 hover:scale-105">
          ...
          <div>
            ...
            <p className="text-sm text-neutral-500">dummy</p>
          </div>
        </div>
        <div className="flex items-start gap-4 pb-10 transition-all duration-500 bg-white border rounded drop-shadow-md p-7 hover:scale-105">
